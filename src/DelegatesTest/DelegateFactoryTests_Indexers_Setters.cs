...
namespace DelegatesTest
{
    ...
    public class DelegateFactoryTests_Indexers_Setters
    {
        ...
        {
            AssertHelper.ThrowsException<ArgumentException>(() => { _testClassType.IndexerSet<string, int>(); });
        }
...
#pragma warning restore 618
        ...
        {
            AssertHelper.ThrowsException<ArgumentException>(() => { _testStrucType.IndexerSetStruct<string, int>(); });
        }
